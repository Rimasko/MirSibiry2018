...
function pano2vrSkin(player, base) {
	...
	this.addSkin = function () {
		...
		this._maptextback.ggLeft = -80;
		this._maptextback.ggTop = -18;
		...
		this._goprevtextback.ggLeft = -80;
		this._goprevtextback.ggTop = -18;
		...
		this._tgotohomeextback.ggLeft = -80;
		this._tgotohomeextback.ggTop = -18;
		...
		this._loadingtext.ggUpdateText = function () {
			var hs = "Загрузка Мира Сибири!... " + (me.player.getPercentLoaded() * 100.0).toFixed(0) + "%";
			if (hs != this.ggText) {
				this.ggText = hs;
		...
		this.mapforMobile.innerHTML = ' <div id="thumbnail-slider"> <div class="inner">  <ul>  <li>  <div>  <a onclick="loadScene77()" class="thumb" href="MobilemapIconstAndText/Baloon_icon.png"></a>  <img onclick="loadScene77()" class="thumb-text" src="MobilemapIconstAndText/Overview_txt.png">  </div>  </li>   <li>                         <div>                             <a  onclick="loadScene71()" class="thumb" href="MobilemapIconstAndText/Craft_icon.png"></a>                             <img onclick="loadScene71()"  class="thumb-text" src="MobilemapIconstAndText/Craft_txt.png">                         </div>                     </li>                     <li>                         <div>                             <a   onclick="loadScene74()" class="thumb" href="MobilemapIconstAndText/Camp_icon.png"></a>                             <img onclick="loadScene74()" class="thumb-text" src="MobilemapIconstAndText/Camp_txt.png">                         </div>                     </li>                     <li>                         <div>                             <a  onclick="loadScene116()" class="thumb" href="MobilemapIconstAndText/Enisey_icon.png"></a>                             <img onclick="loadScene116()"  class="thumb-text" src="MobilemapIconstAndText/Eniseyskaya_Sibir_txt.png">                         </div>                     </li>                     <li>                         <div>                             <a  onclick="loadScene79()" class="thumb" href="MobilemapIconstAndText/Gazebo_icon.png"></a>                             <img onclick="loadScene79()"  class="thumb-text" src="MobilemapIconstAndText/Gazebo_txt.png">                         </div>                     </li>                     <li>                         <div>                             <a  onclick="loadScene72()" class="thumb" href="MobilemapIconstAndText/House_icon.png"></a>                             <img onclick="loadScene72()" class="thumb-text" src="MobilemapIconstAndText/Juravlenok_txt.png">                         </div>                     </li>                     <li>                         <div>                             <a  onclick="loadScene96()" class="thumb" href="MobilemapIconstAndText/Market_icon.png"></a>                             <img onclick="loadScene96()" class="thumb-text" src="MobilemapIconstAndText/Market_txt.png">                         </div>                     </li>                     <li>                         <div>                             <a  onclick="loadScene1()" class="thumb" href="MobilemapIconstAndText/Museum_icon.png"></a>                             <img onclick="loadScene1()" class="thumb-text" src="MobilemapIconstAndText/Museum_txt.png">                         </div>                     </li>                     <li>                         <div>                             <a  onclick="loadScene70()" class="thumb" href="MobilemapIconstAndText/Stage_icon.png"></a>                             <img  onclick="loadScene70()" class="thumb-text" src="MobilemapIconstAndText/Main_stage_txt.png">                         </div>                     </li>                     <li>                         <div>                             <a  onclick="loadScene78()" class="thumb" href="MobilemapIconstAndText/Stove_icon.png"></a>                             <img  onclick="loadScene78()" class="thumb-text" src="MobilemapIconstAndText/Trapeznaya_txt.png">                         </div>                     </li>                     <li>                         <div>                             <a  onclick="loadScene73()" class="thumb" href="MobilemapIconstAndText/Obradovaya.png"></a>                             <img onclick="loadScene73()" class="thumb-text" src="MobilemapIconstAndText/Tribal_txt.png">                         </div>                     </li>                  </ul>             </div>         </div>';
